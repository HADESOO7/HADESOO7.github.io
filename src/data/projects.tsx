...
const ProjectsLinks = ({ live, repo, liveText = "Visit Website" }: { live: string; repo?: string; liveText?: string }) => {
  return (
...
const projects: Project[] = [
  ...
  // +
  {
    ...
    title: "Collex",
    src: "/assets/projects-screenshots/collex/promo_image.png",
    screenshots: ["screen1.png", "screen2.png", "screen3.png", "screen4.png", "screen5.png", "screen6.png", "screen7.png"],
    live: "https://github.com/HADESOO7/Collex/raw/refs/heads/main/releases/collex-v1.0.apk",
    github: "https://github.com/HADESOO7/Collex",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Collex is a fully-featured, cross-platform marketplace application!
          ...
          <ProjectsLinks live={this.live} repo={this.github} liveText="Download apk" />
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/collex/promo_image.png`,
              `${BASE_PATH}/collex/screen1.png`,
              `${BASE_PATH}/collex/screen2.png`,
              `${BASE_PATH}/collex/screen3.png`,
            ]}
          />
          <SlideShow
            images={[
              `${BASE_PATH}/collex/screen4.png`,
              `${BASE_PATH}/collex/screen5.png`,
              `${BASE_PATH}/collex/screen6.png`,
              `${BASE_PATH}/collex/screen7.png`,
            ]}
          />
        </div>
      );
  ...
  { // 01. Image Defocus project
    id: "imagedefocus",
    category: "Machine Learning",
    title: "Image Defocus",
    src: "/assets/projects-screenshots/imagedefocus/image_defocus1.gif",
    screenshots: ["image_defocus1.gif", "image_defocus2.gif", "image_defocus3.gif"],
    live: "https://github.com/HADESOO7/Image-Defocus/archive/refs/heads/master.zip",
    github: "https://github.com/HADESOO7/Image-Defocus",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Synthetic Defocusing using Monocular Depth Estimation. Graded blurring of an image based on how far a point is from focus using just a single image with no extra data. To achieve this we generate a depth map for the image using machine learning.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} liveText="Download zip" />
          <TypographyH3 className="my-4 mt-8">Depth Estimation</TypographyH3>
          <ul className="list-disc ml-6 font-mono space-y-2">
            <li><strong>Tensorflow Model:</strong> Trained on a large set of stereo(left-right) images to generate a right image from a given left image, implicitly learning depth.</li>
            <li><strong>Interactive UI:</strong> Clicking anywhere sets that as the point of focus, regenerating the blurred image based on relative depth.</li>
          </ul>
          <SlideShow
            images={[
              `${BASE_PATH}/imagedefocus/image_defocus1.gif`,
              `${BASE_PATH}/imagedefocus/image_defocus2.gif`,
              `${BASE_PATH}/imagedefocus/image_defocus3.gif`,
            ]}
          />
        </div>
      );
  ...
  { // 02. Recipe Finder project
    id: "recipefinder",
    category: "AI & Computer Vision",
    title: "Recipe Finder",
    src: "/assets/projects-screenshots/recipefinder/homepage-dark.png",
    screenshots: [
      "homepage-dark.png",
      "homepage-white.png",
      "chocolate-cake.png",
    ...
    live: "https://github.com/HADESOO7/Recipe-Finder/archive/refs/heads/main.zip",
    github: "https://github.com/HADESOO7/Recipe-Finder",
    skills: {
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyH3 className="my-4 mt-8">AI Recipe Generation</TypographyH3>
          <p className="font-mono mb-2">
            Uses a PyTorch-based Computer Vision/NLP model to extract ingredients and instructions from a single image. The huge PyTorch models only load into memory once on boot, making every subsequent upload lightning-fast.
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/recipefinder/homepage-dark.png`,
              `${BASE_PATH}/recipefinder/homepage-white.png`,
            ]}
          />
          
          <TypographyH3 className="my-4 mt-8">Food Image Validation</TypographyH3>
          <p className="font-mono mb-2">
            Integrates a lightweight ResNet18 classifier to automatically reject non-food images before wasting resources on generation!
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/recipefinder/avengers.png`,
            ]}
          />
          
          <TypographyH3 className="my-4 mt-8">Beautiful Modern UI</TypographyH3>
          <p className="font-mono mb-2">
            Features a sleek Glassmorphism design, centralized flex-box layout, smooth micro-animations, and a fully functional Dark / Light mode toggle that remembers your preference!
          </p>
          <SlideShow
            images={[
              `${BASE_PATH}/recipefinder/chocolate-cake.png`,
              `${BASE_PATH}/recipefinder/recipe-white.png`,
            ]}
          />
        </div>
      );
  ...
  { // 04. YouTube Clone project
    id: "ytclone",
    category: "Frontend Clone",
    title: "YouTube Clone",
    src: "/assets/projects-screenshots/ytclone/screenshot.png",
    screenshots: ["screenshot.png"],
    live: "https://hadesoo7.github.io/YT-clone/",
    github: "https://github.com/HADESOO7/YT-clone",
    skills: {
      frontend: [PROJECT_SKILLS.html, PROJECT_SKILLS.css, PROJECT_SKILLS.js],
      backend: [],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            A pixel-perfect, responsive replica of the YouTube interface built with Vanilla HTML, CSS, and JavaScript. This project features a dynamic video grid, collapsible sidebar, and functional search filtering.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          
          <TypographyH3 className="my-4 mt-8">Responsive Grid & Dynamic UI</TypographyH3>
          <ul className="list-disc ml-6 font-mono space-y-2">
            <li><strong>Responsive Grid:</strong> A layout that adapts from 1 column on mobile to 4+ columns on desktop screens.</li>
            <li><strong>Dynamic Video Cards:</strong> Video thumbnails, titles, and channel data are generated dynamically via JavaScript.</li>
            <li><strong>Collapsible Sidebar:</strong> A toggle button (Hamburger menu) that expands or minimizes the side navigation.</li>
          </ul>
          
          <TypographyH3 className="my-4 mt-8">Interface Preview</TypographyH3>
          <SlideShow
            images={[
              `${BASE_PATH}/ytclone/screenshot.png`,
            ]}
          />
        </div>
      );
  ...
  { // 05. Pro Calculator project
    id: "procalculator",
    category: "Web Application",
    title: "Pro Scientific Calculator",
    src: "/assets/projects-screenshots/procalculator/screen1.png",
    screenshots: ["screen1.png", "screen2.png"],
    live: "https://hadesoo7.github.io/Pro-Calculator/",
    github: "https://github.com/HADESOO7/Pro-Calculator",
    skills: {
      frontend: [PROJECT_SKILLS.html, PROJECT_SKILLS.css, PROJECT_SKILLS.js],
      backend: [],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            A high-performance, web-based scientific calculator featuring a mobile-first dark mode UI, history tracking, and advanced trigonometric functions. It emphasizes user experience (UX) through a distraction-free dark mode interface, tactile button feedback, and fluid animations.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          
          <TypographyH3 className="my-4 mt-8">Advanced Capabilities</TypographyH3>
          <ul className="list-disc ml-6 font-mono space-y-2">
            <li><strong>Advanced Math:</strong> Full support for Trigonometry (sin, cos, tan), Logarithms (log, ln), Roots, and Exponents.</li>
            <li><strong>Smart History:</strong> A slide-up drawer stores past calculations. Clicking a history item re-inserts the result for new calculations.</li>
            <li><strong>Error Handling:</strong> Intelligent syntax parsing prevents app crashes on invalid inputs.</li>
          </ul>
          
          <TypographyH3 className="my-4 mt-8">Interface Preview</TypographyH3>
          <SlideShow
            images={[
              `${BASE_PATH}/procalculator/screen1.png`,
              `${BASE_PATH}/procalculator/screen2.png`,
            ]}
          />
        </div>
      );
